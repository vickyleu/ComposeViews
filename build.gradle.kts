...
val publishGroup = "io.github.vickyleu.composeviews"
val publishVersion = "2.0.0"
val publishRepo = "ComposeViews"
...
subprojects {
    ...
    extensions.configure<MavenPublishBaseExtension>("mavenPublishing") {
        ...
        pom {
            name.set("Vickyleu KMP ComposeViews ${project.name}")
            description.set("Compose Multiplatform view components.")
